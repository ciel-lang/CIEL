...
** With a binary. Use CIEL's own REPL.
   ...
   You can build it. Clone this repository, run =make build= and then
   =./ciel-repl=.

   You are dropped into a custom Lisp REPL, freely based onto [[https://github.com/hellerve/sbcli][sbcli]].
