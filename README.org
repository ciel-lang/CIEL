...
#+begin_src txt
  ...
  :doc => Print the available documentation for this symbol, including wether it is of type variable, function, structure, type or setf.
...
#+end_src
  ...
  For more, see also [[https://github.com/koji-kojiro/cl-repl/][cl-repl]].
